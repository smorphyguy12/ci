...
// TCPDF configuration
require_once(dirname(__FILE__).'\TCPDF-main\tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'\TCPDF-main\include\tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'\TCPDF-main\include\tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'\TCPDF-main\include\tcpdf_colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'\TCPDF-main\include\tcpdf_images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'\TCPDF-main\include\tcpdf_static.php');
